...
# t.me/pain_screen_bot
TOKEN = '6308483941:AAFXasgvamn6rae4aTr989rulIImGr8qnEE'
...
def main(message):
    ...
    ls_dict[message.chat.id].append(
        bot.send_message(message.chat.id,
                         "<b>Привет</b> 👋  \n В этом боте ты сможешь скачать приложение «Paint screen», где можно рисовать на заставке друг друга. \n Жми «продолжить», чтобы получить приложение 🤫",
